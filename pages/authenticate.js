...
const Cuenta = () => {
    ...
    const fetchUserId = async (acToken = null) => {
        try {
            const response = await fetch(`https://account-service-13535404425.us-central1.run.app/api/v1/resources/token-metadata?token=${acToken ? acToken : token}`, {
                method: 'GET',
                headers: {
    ...
    const fetchUserData = async (acToken = null) => {
        try {
            const response = await fetch(`https://account-service-13535404425.us-central1.run.app/api/v1/users/`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
    ...
    const updateUserCredential = async (type, value) => {
        try {
            const response = await fetch(`https://account-service-13535404425.us-central1.run.app/api/v1/users/credentials`, {
                method: 'PATCH',
                headers: {
                    "Content-Type": "application/json",
    ...
    const handleConfirmVerificationCode = async () => {
        try {
            const response = await fetch(`https://account-service-13535404425.us-central1.run.app/api/v1/users/verify`, {
                method: 'PATCH',
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${token}`
    ...
    const handleBlockAccount = async () => {
        try {
            const response = await fetch(`https://account-service-13535404425.us-central1.run.app/api/v1/users/block`, {
                method: 'PUT',
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${token}`
